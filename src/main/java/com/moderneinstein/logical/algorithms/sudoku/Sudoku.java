...
public class Sudoku{
    ...
    public static void solveSudoku(String[][] board){
        ...
        Integer[][] sheet = Filter.filter1(board);
    ...
    //        for(int j=0;j<var2;j++){
         //       if(sheet[i][j]==0){
                ...
                System.out.println(Arrays.deepToString(sheet));
              //  //System.out.println(Arrays.deepToString(sheet));
                System.out.println(Validator.validate(sheet));
                //if(){
 ...
 //   } 
        ...
        for(int i=0;i<sheet.length;i++){
            for(int j=0;j<sheet[0].length;j++){
                ret1[i][j]=(sheet[i][j]).intValue();
                solution[i][j]=(char)(ret1[i][j]+48);
              //  board[i][j]=(sheet[i][j]).toString();
                board[i][j] = String.valueOf(solution[i][j])  ; 
            }
        }
        //solution = (char[][])ret1;
